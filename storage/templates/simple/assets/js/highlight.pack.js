...
end:/}}/,contains:["self",t,n]}]}}}());hljs.registerLanguage("bash",function(){"use strict";return function(e){
...
begin:t,end:a,contains:[n],relevance:5}])}}}());hljs.registerLanguage("asciidoc",function(){"use strict";return function(e){
...
excludeBegin:!0,excludeEnd:!0,relevance:0}],relevance:10}]}}}());hljs.registerLanguage("yaml",function(){"use strict";return function(e){
...
className:"symbol",begin:/<[\w-]+>/}]}}}());hljs.registerLanguage("excel",function(){"use strict";return function(E){return{
...
contains:a}}}());hljs.registerLanguage("dns",function(){"use strict";return function(d){return{
...
},d.inherit(d.NUMBER_MODE,{begin:/\b\d+[dhwm]?/})]}}}());hljs.registerLanguage("cpp",function(){"use strict";return function(e){
